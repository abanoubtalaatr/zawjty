...
@section('content')
    <div class="container-fluid section-intro-privecy">
        <div class="row row-cols-1 row-cols-md-1 row-privecy">
            ...
            <h3 class="card-title">نساء يطلبن زواج المسيار</h3>
            ...
            <div class="row row-cols-2 row-cols-md-2 new-online-mwda">
                <div class="col mb-4 mt-4">
                    <div class="card text-right">
                        <div class="card-body">
                            <h5 class="card-title">نساء يطلبن زواج المسيار</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-4 mt-5">
                    <div class="card card-person">
                        ...
                        <details open="" class="text-right">
                            ...
                            <p>
                                <span class="details-sp"> الدوله : </span>  @if($user->country) {{$user->country->name}}@endif
                            </p>
                            <p>
